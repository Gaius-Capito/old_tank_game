...
from bullet import EnemyState, EnemyState2, EnemyState3, EnemyState4
...
class Enemy2(Sprite):
    ...
    def update(self):
        ...
        if self._dir == 2:
            ...
            self.y -= self.settings.enemy_speed
            self.image = self.image_t
        EnemyState2.direction = self._dir
        self.rect.y = self.y
        self.rect.x = self.x
...
class Enemy3(Sprite):
    ...
    def update(self):
        ...
        if self._dir == 2:
            ...
            self.y -= self.settings.enemy_speed
            self.image = self.image_t
        EnemyState3.direction = self._dir
        self.rect.y = self.y
        self.rect.x = self.x
...
class Enemy4(Sprite):
    ...
    def update(self):
        ...
        if self._dir == 2:
            ...
            self.y -= self.settings.enemy_speed
            self.image = self.image_t
        EnemyState4.direction = self._dir
        self.rect.y = self.y
        self.rect.x = self.x
