...
class EnemyBullet2(Sprite):
    ...
    def __init__(self, ot_game):
        ...
        self.color = self.settings.enemy_bullet_color
        self.rect = pygame.Rect(0, 0, self.settings.bullet_width, self.settings.bullet_height)  # Создание снаряда в позиции (0,0) и назначение правильной позиции.
        self.__direction = EnemyState2.direction
        self.__bullet_pos(ot_game)
        self.y = float(self.rect.y)  # Позиция снаряда хранится в виде десятичной дроби.
        self.x = float(self.rect.x)
    ...
    def __bullet_pos(self, ot_game):
        if self.__direction == 1:
            self.rect.midtop = ot_game.enemy_rect2[0].rect.midtop
        elif self.__direction == 2:
            self.rect.midright = ot_game.enemy_rect2[0].rect.midright
        elif self.__direction == 3:
            self.rect.midbottom = ot_game.enemy_rect2[0].rect.midbottom
        elif self.__direction == 4:
            self.rect.midleft = ot_game.enemy_rect2[0].rect.midleft
...
class EnemyBullet3(Sprite):
    ...
    def __init__(self, ot_game):
        ...
        self.color = self.settings.enemy_bullet_color
        self.rect = pygame.Rect(0, 0, self.settings.bullet_width, self.settings.bullet_height)  # Создание снаряда в позиции (0,0) и назначение правильной позиции.
        self.__direction = EnemyState3.direction
        self.__bullet_pos(ot_game)
        self.y = float(self.rect.y)  # Позиция снаряда хранится в виде десятичной дроби.
        self.x = float(self.rect.x)
    ...
    def __bullet_pos(self, ot_game):
        if self.__direction == 1:
            self.rect.midtop = ot_game.enemy_rect3[0].rect.midtop
        elif self.__direction == 2:
            self.rect.midright = ot_game.enemy_rect3[0].rect.midright
        elif self.__direction == 3:
            self.rect.midbottom = ot_game.enemy_rect3[0].rect.midbottom
        elif self.__direction == 4:
            self.rect.midleft = ot_game.enemy_rect3[0].rect.midleft


class EnemyBullet4(Sprite):
    """
    Класс для управления снарядами, выпущенными танком
    """
    def __init__(self, ot_game):
        ...
        self.color = self.settings.enemy_bullet_color
        self.rect = pygame.Rect(0, 0, self.settings.bullet_width, self.settings.bullet_height)  # Создание снаряда в позиции (0,0) и назначение правильной позиции.
        self.__direction = EnemyState4.direction
        self.__bullet_pos(ot_game)
        self.y = float(self.rect.y)  # Позиция снаряда хранится в виде десятичной дроби.
        self.x = float(self.rect.x)
    ...
    def __bullet_pos(self, ot_game):
        if self.__direction == 1:
            self.rect.midtop = ot_game.enemy_rect4[0].rect.midtop
        elif self.__direction == 2:
            self.rect.midright = ot_game.enemy_rect4[0].rect.midright
        elif self.__direction == 3:
            self.rect.midbottom = ot_game.enemy_rect4[0].rect.midbottom
        elif self.__direction == 4:
            self.rect.midleft = ot_game.enemy_rect4[0].rect.midleft
