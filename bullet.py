...
class EnemyBullet(Sprite):
    ...
    def __bullet_pos(self, ot_game):
        if self.__direction == 1:
            self.rect.midtop = ot_game.enemy.rect.midtop
        elif self.__direction == 2:
            self.rect.midright = ot_game.enemy.rect.midright
        elif self.__direction == 3:
            self.rect.midbottom = ot_game.enemy.rect.midbottom
        elif self.__direction == 4:
            self.rect.midleft = ot_game.enemy.rect.midleft
